    ...
    >
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        ...
        <div className="mb-10 sm:mb-14">
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 text-[13px] font-medium transition-colors group"
            style={{ color: "#6A6A72" }}
          >
            <ArrowLeft
              size={13}
        ...
        <div className="mb-14 sm:mb-20">
          <span className="eyebrow mb-4 block">Complete Feature List</span>
          <h1
            className="text-[36px] sm:text-5xl font-black tracking-tight mb-4 sm:mb-5"
            style={{
              color: "#F2F2F7",
          ...
          <p
            className="max-w-xl text-[15px] sm:text-base leading-relaxed sm:leading-loose"
            style={{ color: "#8E8E94" }}
          >
            12 features built for serious poker players — from your first
            session photo to your deepest hand history.
          </p>
        </div>
              ...
              <div key={category}>
                ...
                >
                  {catFeatures.map((feature) => {
                    ...
                    const tierStyle =
                      tierStyles[feature.tier] ?? tierStyles["Free"];
                    const cardStyle = {
